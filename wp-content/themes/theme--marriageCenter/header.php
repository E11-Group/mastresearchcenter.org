...
<head>
    ...
    <style type="text/css">
        /*.measure-topic, .measure-subtopic, .measure-data, .save-data{
            display: none;
        }*/
    </style>
    <?php /*
            ...
            <div class="header__intro">
                ...
                <div class="header__intro__followUs">
                    ...
                    <ul>
                        ...
                        <?php /*<li><a href="#" data-modal-id="signUpForm"><i class="icon icon--search"><?php echo file_get_contents(get_stylesheet_directory() . '/images/icon__email.svg'); ?></i></a></li>*/?>
                    </ul>
                </div>
            </div>
        <?php endif; ?>
