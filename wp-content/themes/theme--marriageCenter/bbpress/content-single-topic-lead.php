...
<ul class="disputo-replies-bar">
    ...
    <li class="disputo-replies-links">
        ...
        <span class="disputo-replies-favorites"><?php bbp_user_favorites_link(array('favorite' => '<i class="fa fa-heart"></i>','favorited' => '<i class="fa fa-heart"></i>')); ?></span>
    </li>
</ul>
            ...
            <div class="disputo-replies-wrapper">
                <div class="disputo-replies-author">
                    ...
                    <div class="disputo-replies-author-info">
                        ...
                        <?php } ?>
                        <a tabindex="0" class="disputo-popover" data-container="body" data-trigger="focus" data-toggle="popover" data-placement="bottom" data-content="<?php esc_attr_e( 'Topics Started', 'disputo' ); ?>: <?php echo esc_attr(bbp_get_user_topic_count_raw(bbp_get_topic_author_id())); ?><br><?php esc_attr_e( 'Replies Created', 'disputo' ); ?>: <?php echo esc_attr(bbp_get_user_reply_count_raw(bbp_get_topic_author_id())); ?>" data-original-title="<?php esc_attr_e( 'Statistics', 'disputo') ?>"><i class="fa fa-bar-chart"></i></a>
