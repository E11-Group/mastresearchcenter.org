	...
	<fieldset class="bbp-form disputo-edit-profile-section">
        ...
        <div class="form-row mb-3">
            <div class="col">
                ...
                <?php disputo_edit_user_language(); ?>
            </div>
            <div class="col">
		...
		<div class="form-group">
            ...
            <div class="bbp-template-notice">
				<p>
<?php esc_html_e('There is a pending email address change to', 'disputo'); ?> <?php echo esc_html($new_email['newemail']); ?> <a href="<?php echo esc_url( self_admin_url( 'user.php?dismiss=' . bbp_get_current_user_id()  . '_new_email' )); ?>"><?php esc_html_e('Cancel', 'disputo'); ?></a>
				</p>
            </div>
			<?php endif; ?>
		...
		<div id="password" class="form-group">
			<label for="pass1"><?php esc_html_e( 'New Password', 'disputo' ); ?></label>
			<fieldset class="bbp-form password">
				...
				<p><small><?php esc_html_e( 'If you would like to change the password type a new one. Otherwise leave this blank.', 'disputo' ); ?></small></p>

				<input type="password" class="form-control" name="pass2" id="pass2" size="16" value="" autocomplete="off" tabindex="<?php bbp_tab_index(); ?>" />
				<p><small><?php esc_html_e( 'Type your new password again.', 'disputo' ); ?></small></p>

				<div class="bbp-template-notice no-margin">
				<p><?php esc_html_e( 'Your password should be at least ten characters long. Use upper and lower case letters, numbers, and symbols to make it even stronger.', 'disputo' ); ?></p>
                </div>
			</fieldset>
		</div>
