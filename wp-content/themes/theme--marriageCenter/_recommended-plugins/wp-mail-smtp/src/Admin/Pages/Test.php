...
class Test extends PageAbstract {
	...
	private function get_email_message_html() {
		...
		<head>
			...
			<style type="text/css">@media only screen and (max-width: 599px) {table.body .l-container {width: 95% !important;}.header {padding: 15px 15px 12px 15px !important;}.header img {width: 200px !important;height: auto !important;}.content, .aside {padding: 30px 40px 20px 40px !important;}}</style>
		</head>
