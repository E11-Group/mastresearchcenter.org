...
function jp_register_post_types() {
	...
	$jp_magic_post_type_maker_array = [
		...
		*/
		...
		[
			'slug' => 'resources', // Lowercase letters, dashes only. Probably should be plural.
			'singular' => 'Resource', // Capitalized, something like 'Resource' or 'Staff Member'
			'plural' => 'Resources', // Capitalized, something like 'Resource' or 'Staff Members'
			'register_args' => [ // Explained above.
				'menu_icon' => 'dashicons-media-text',
				'description' => 'Manage your Resources.',
				'rewrite' => array(
					'slug' => 'evaluation-resource-library',
				),
			],
		...
		[
			'slug' => 'research', // Lowercase letters, dashes only. Probably should be plural.
			'singular' => 'Research', // Capitalized, something like 'Resource' or 'Staff Member'
			'plural' => 'Research', // Capitalized, something like 'Resource' or 'Staff Members'
			'register_args' => [ // Explained above.
				'menu_icon' => 'dashicons-media-text',
				'description' => 'Manage your Research.',
				'rewrite' => array(
					'slug' => 'mast-center-research',
				),
			],
		...
		[
			'slug' => 'measure', // Lowercase letters, dashes only. Probably should be plural.
			'singular' => 'Measure', // Capitalized, something like 'Resource' or 'Staff Member'
			'plural' => 'Measures', // Capitalized, something like 'Resource' or 'Staff Members'
			'register_args' => [ // Explained above.
				'menu_icon' => 'dashicons-media-text',
				'description' => 'Manage your Measures.',
				'rewrite' => array(
					'slug' => 'mast-measure',
				),
			],
