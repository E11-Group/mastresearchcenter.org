<main class="main">
    ...
    <div class="resourcesSearch searchBar">
        <div class="l-container">
                <form method="get" action="<?php echo get_post_type_archive_link('resources'); ?>">
        ...
        <div class="l-container">
            <div class="archive__row flexRow">
                <aside class="archive__sidebar">
                    ...
                    <form id="resourcesFilterForm" class="archive__filters" action="<?php echo get_post_type_archive_link('resources'); ?>" method="get">
                        <?php
                        ...
                        $date = get_terms('date', array('hide_empty' => false, 'parent' => 0, 'order' => 'DESC', 'ignore_term_order' => true));
                        ...
                        $sanitized_focus_areas = array();
                        if( isset($_GET['focus-areas']) && is_array($_GET['focus-areas']) ){
                            foreach( $_GET['focus-areas'] as $key => $value ){
                                $sanitized_focus_areas[ sanitize_text_field($key) ] = sanitize_text_field($value);
                            }
                        }
                        ...
                        <div class="archive__filter">
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($focus_areas as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        <input <?php if( in_array( $item->slug, $sanitized_focus_areas ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $item->slug; ?>" name="focus-areas[]" value="<?php echo $item->slug; ?>" type="checkbox">
                                        <label class="archive__filter__label" for="<?php echo $item->slug; ?>"><?php echo $item->name; ?></label>
                                        <?php
                                        $itemChildrenArgs = array(
                                           'hierarchical' => 1,
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_focus_areas ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="focus_areas[]" value="<?php echo $child->slug; ?>" type="checkbox">
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($evaluation_designs as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_types ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="evaluation-design[]" value="<?php echo $child->slug; ?>" type="checkbox">
                                            <label class="archive__filter__label archive__filter__label--child" for="<?php echo $child->slug; ?>"><?php echo $child->name; ?></label>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($program_focus as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_types ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="program-focus[]" value="<?php echo $child->slug; ?>" type="checkbox">
                                            <label class="archive__filter__label archive__filter__label--child" for="<?php echo $child->slug; ?>"><?php echo $child->name; ?></label>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($relationship_type as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_types ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="relationship-type[]" value="<?php echo $child->slug; ?>" type="checkbox">
                                            <label class="archive__filter__label archive__filter__label--child" for="<?php echo $child->slug; ?>"><?php echo $child->name; ?></label>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($populations as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_types ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="populations[]" value="<?php echo $child->slug; ?>" type="checkbox">
                                            <label class="archive__filter__label archive__filter__label--child" for="<?php echo $child->slug; ?>"><?php echo $child->name; ?></label>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($community_type as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_types ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="community-type[]" value="<?php echo $child->slug; ?>" type="checkbox">
                                            <label class="archive__filter__label archive__filter__label--child" for="<?php echo $child->slug; ?>"><?php echo $child->name; ?></label>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                            ...
                            <div class="archive__filter__itemGroupWrap">
                                <?php foreach($date as $item): ?>
                                    <div class="archive__filter__itemGroup">
                                        ...
                                        foreach($itemChildren as $child): ?>
                                            <input <?php if( in_array( $child->slug, $sanitized_types ) ){ ?>checked<?php } ?> class="archive__filter__checkbox" id="<?php echo $child->slug; ?>" name="date[]" value="<?php echo $child->slug; ?>" type="checkbox">
                                            <label class="archive__filter__label archive__filter__label--child" for="<?php echo $child->slug; ?>"><?php echo $child->name; ?></label>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endforeach; ?>
                        ...
                        <div class="archive__list__results">
                            ...
                            <div class="archive__list__results__sort">
                                ...
                                <select name="#" id="archive__list__results__sort__select">
                                    ...
                                    <option <?php if( (isset($_GET['order']) && $_GET['order'] == 'ASC')){ echo 'selected'; } ?> id="resourceOrderAsc" value="ASC">Oldest to Newest</option>
