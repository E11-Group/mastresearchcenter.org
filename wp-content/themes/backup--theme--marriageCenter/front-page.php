                        ...
                        <div class="featuredCard">
                            <div class="featuredCard__inner">
                                <header class="featuredCard__header">
                                    <span class="featuredCard__header__label">Featured MAST Center <?php echo ucfirst($post->post_type); ?></span>
                                    <span class="featuredCard__header__date"><?php echo get_the_date('F j, Y'); ?></span>
                                </header>
